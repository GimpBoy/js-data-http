/*!
* js-data-http
* @version 3.0.1 - Homepage <https://github.com/js-data/js-data-http>
...
Adapter.extend({
  ...
  HTTP: function HTTP(config, opts) {
    ...
    config = jsData.utils.copy(config, null, null, null, ['data', 'cache', 'timeout', 'params']); // params could have data, cache, timeout
    config.params = jsData.utils.copy(params);
